...
def main():
    ...
    parser.add_argument(
        "--ft_optimize_data", default=None, type=str, dest="ft_optimize_data", help="Path to the dataset to use for FT optimization."
    )
    parser.add_argument(
        "--ft_optimize_count", default=10000, type=int, dest="ft_optimize_count", help="Number of positions to use for FT optimization."
    )
